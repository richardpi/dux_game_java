...
public class Sound {
	...
	public Sound() {
		mainClip = prepareClip("sfx/main.wav");
		shootClip = prepareClip("sfx/shoot.wav");
		hitClip = prepareClip("sfx/hit.wav");
		bulletRemoveClip = prepareClip("sfx/bulletRemove.wav");
		startClip = prepareClip("sfx/start.wav");
		gameOverClip = prepareClip("sfx/end.wav");
		completedClip = prepareClip("sfx/count.wav");
	}
	...
	private static Clip prepareClip(String filename) {
		...
		try {
			File file = new File(Main.classLoader.getResource(filename).getFile());
			if (file.exists()) {
