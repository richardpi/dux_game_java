...
public class Assets {
	...
	public Assets(Component comp) {
		...
		gun = new Gun();
		gun.setGunPic(loaderTools.loadImage("graphics/gun.png"));
		Bullet.setPic(loaderTools.loadImage("graphics/bullet.png"));
		keyboard = loaderTools.loadImage("graphics/keyboard.png");
	}
}
