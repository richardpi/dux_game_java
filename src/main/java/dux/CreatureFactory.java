...
public class CreatureFactory {
	...
	public static Duck createDuck() {
		return (Duck) createCreature("graphics/dux.png", new Duck());
	}

	public static Owl createOwl() {
		return (Owl) createCreature("graphics/owl.png", new Owl());
	}

	public static Rabbit createRabbit() {
		return (Rabbit) createCreature("graphics/rabbit.png", new Rabbit());
	}
	...
	public static Points createPoints() {
		Points c = new Points();
		Image imageRight = Assets.loaderTools.loadImage("graphics/points10.png");
		Image imageLeft = Assets.loaderTools.loadImage("graphics/points5.png");
